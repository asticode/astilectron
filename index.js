    ...
    switch (json.name) {
      ...
      case consts.eventNames.sessionCmdLoadExtension:
        elements[json.targetID].loadExtension(json.path).then(() => {
          client.write(
            json.targetID,
            consts.eventNames.sessionEventLoadedExtension
          );
        });
        break;
      ...
      case consts.eventNames.windowCmdWebContentsExecuteJavascript:
        ...
        break;
      case consts.eventNames.customEventInterceptCaptchaRequests:
        handleCaptchaRequestsInWindow(elements[json.targetID], json.html);
    }
  });
